...
class mainFragment : Fragment(), mainContract.View, LifecycleOwner {
    ...
    val adapter:mainAdapter by lazy { return@lazy mainAdapter(context!!) }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val georepository = getGeoRepository(activity!!)
        val datarepository = getDataRepository(activity!!, georepository)
